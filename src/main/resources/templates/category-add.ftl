        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="/category/toCategoryAdd"
                       class="list-group-item text-center active">新增</a>
                </div>
            </div>
            <!-- 右侧内容 -->
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">新增种类</div>
                    <div class="panel-body">
                        <form action="/category/add" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="c_product" class="form-control" placeholder="名称">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="0">PC
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="1">掌机
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="2">主机
                                    </label>
                                </div>
                                <div class="col-sm-5">
